					...
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" action="{{ route('daftar') }}" method="POST">
								...
								<div class="bottom">
									<!-- Tambahkan pesan jika pengguna sudah memiliki akun -->
									<span class="helper-text">Sudah punya akun? <a href="{{ route('login') }}">Masuk ke Akun Anda</a></span>
								</div>
							</form>
