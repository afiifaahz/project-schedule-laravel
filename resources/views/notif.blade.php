                ...
                <div class="panel panel-headline">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <h2><b>Jadwal yang Akan Datang</b></h2>

                            @foreach($schedules as $schedule)
                                <div class="col-md-3">
                                    <div class="metric">
                                        <div class="alert alert-info" role="alert">
                                            <strong>Perhatian!</strong> <br> {{$schedule->judul}} akan dimulai hari ini.
                                            <strong>Lokasi:</strong> <br> {{$schedule->lokasi}} <br>
                                            <strong>Waktu Mulai:</strong> <br> {{$schedule->waktu_mulai}} 
